...
for n in range(n_start, n_end, n_step): #number of words in each document
    ...
    score_table_train[int(n/n_step-1), 0] = classifier1.score(text_bow_train, y_train)
    ...
    score_table_train[int(n/n_step-1), 1] = classifier2.score(text_bow_train, y_train)
    ...
    score_table_train[int(n/n_step-1), 2] = classifier3.score(text_bow_train, y_train)
    ...
    score_table_train[int(n/n_step-1), 3] = classifier4.score(text_bow_train, y_train)
    ...
    score_table_train[int(n/n_step-1), 4] = classifier5.score(text_bow_train, y_train)
...
if not os.path.exists('./BoW_results'):
    os.makedirs('BoW_results')
# =============================================================================
...
for i in range(0, 5):
    ...
    plt.legend() 
    plt.savefig("./BoW_results/{} - Bag of Words Error Analysis.png".format(classifiers[i]))
    plt.show()
    plt.clf()
np.savetxt("./BoW_results/Score_BoW_test.csv", score_table, delimiter=",")
np.savetxt("./BoW_results/Score_BoW_Train.csv", score_table_train, delimiter=",")
# =============================================================================
