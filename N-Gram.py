...
for n in range(n_start, n_end, n_step): #number of words in each document
    ...
    score_table_train[int(n/n_step-1), 0] = classifier1.score(text_ngram_train, y_train)
    ...
    score_table_train[int(n/n_step-1), 1] = classifier2.score(text_ngram_train, y_train)
    ...
    score_table_train[int(n/n_step-1), 2] = classifier3.score(text_ngram_train, y_train)
    ...
    score_table_train[int(n/n_step-1), 3] = classifier4.score(text_ngram_train, y_train)
    ...
    score_table_train[int(n/n_step-1), 4] = classifier5.score(text_ngram_train, y_train)
