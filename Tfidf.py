...
for n in range(10, 200, 10): #number of words in each document
    ...
    score_table_train[int(n/10-1), 0] = classifier1.score(text_Tfidf_train, y_train)
    ...
    score_table_train[int(n/10-1), 1] = classifier2.score(text_Tfidf_train, y_train)
    ...
    score_table_train[int(n/10-1), 2] = classifier3.score(text_Tfidf_train, y_train)
    ...
    score_table_train[int(n/10-1), 3] = classifier4.score(text_Tfidf_train, y_train)
    ...
    score_table_train[int(n/10-1), 4] = classifier5.score(text_Tfidf_train, y_train)
...
for i in range(0, 5):
    ...
    plt.show()
    plt.clf()
np.save("Tfidf.csv", score_table)
np.savetxt("Tfidf.csv", score_table, delimiter=",")
np.savetxt("Tfidf - Train.csv", score_table_train, delimiter=",")
# =============================================================================
